                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-900/50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider">Check-in Date/Time</th>
                                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider">Check-out Date/Time</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($bookings as $booking)
                                    <tr>
                                        ...
                                        <td class="px-4 py-3">{{ $booking->check_in_date->format('M d, Y h:i A') }}</td>
                                        <td class="px-4 py-3">{{ $booking->check_out_date->format('M d, Y h:i A') }}</td>
                                    </tr>
                                @empty
                                    <tr>
