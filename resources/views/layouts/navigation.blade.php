<nav x-data="{ open: false }" class="bg-white/70 dark:bg-[#1E1C1A]/70 backdrop-blur-md border-b border-[#E8E6E1]/60 dark:border-[#2C2A28]/60 sticky top-0 z-50 transition-colors duration-300">
